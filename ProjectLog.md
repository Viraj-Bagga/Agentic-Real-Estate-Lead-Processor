...
[Date] - Feature : ----
*Context: What needed to get done (Needed to extract ceratin data)
*Decision: What got done (Implement Pydantic-based schema to force the LLM to return valid JSON)
...
*Decision: 
**Documentation**: Created 2 layers of documentation, one being the README.md for the general project outline and the ProjectLog.md for daily project updates
